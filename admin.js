...
window.adminLogin=async()=>{
  ...
  if(!user || !pass){ alert("Isi email dan password terlebih dahulu."); return; }
  ...
  try{
    ...
    console.error(e);
    alert(e?.code==="auth/invalid-credential" || e?.code==="auth/wrong-password" ? "Email atau password salah." : "Login gagal. Pastikan Firebase Authentication Email/Password aktif dan firebase-config.js benar.");
